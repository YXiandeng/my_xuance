...
class MADDPG_EA_Agents(MARLAgents):
    """The implementation of MADDPG_EA agents.
    ...
    def __init__(self,
        ...
        memory = MARL_OffPolicyBuffer(config.n_agents,
                                      ...
                                      config.buffer_size,
                                      config.batch_size)
        learner = MADDPG_EA_Learner(config, policy, optimizer, scheduler,
                                 config.device, config.model_dir, config.gamma)
        super(MADDPG_EA_Agents, self).__init__(config, envs, policy, memory, learner, device,
